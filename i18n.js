(function(){
  var translations = {
    ...
    bg: {
      ...
      p2_highlight: 'Имейл адрес за секунди, без регистрация и излишни усложнения.',
      p2_desc: 'Услуга за временни имейли — взимаш адрес веднага, писмата идват в реално време, всичко в зелен CRT интерфейс като от Матрицата.',
