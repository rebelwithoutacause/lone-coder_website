(function(){
  var translations = {
    en: {
      ...
      p2_highlight: 'An email address in seconds — no signup, no hassle.',
      p2_desc: 'A temp email service — you get an address instantly, messages show up in real time, all in a green CRT interface straight out of the Matrix.',
    ...
    ru: {
      ...
      p2_highlight: 'Почтовый адрес за секунды — без регистрации и лишних сложностей.',
      p2_desc: 'Сервис временной почты — получаешь адрес сразу, письма приходят в реальном времени, всё в зелёном CRT-интерфейсе прямо как в Матрице.',
    ...
    de: {
      ...
      p2_highlight: 'E-Mail-Adresse in Sekunden — ohne Anmeldung, ohne Aufwand.',
      p2_desc: 'Ein Temp-Mail-Dienst — du bekommst sofort eine Adresse, Nachrichten kommen in Echtzeit an, alles in einem grünen CRT-Interface wie aus der Matrix.',
