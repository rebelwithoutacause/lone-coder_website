(function(){
  var translations = {
    ...
    bg: {
      ...
      p6_desc: 'Уеб плейър за интернет радио, стилизиран като телефон — RockStation — излъчващ 5 подбрани жанра (Rock, Metal, Gothic, Synthwave, Alternative) от безплатни живи стриймове, с любими станции, споделяеми линкове и управление от заключения екран чрез Media Session API, изцяло в браузъра.',
    ...
    ru: {
      ...
      p6_desc: 'Веб-плеер интернет-радио в виде телефона — RockStation — транслирующий 5 подобранных жанров (Rock, Metal, Gothic, Synthwave, Alternative) из бесплатных живых потоков, с избранным, ссылками для быстрого доступа и управлением с экрана блокировки через Media Session API, полностью на стороне клиента.',
