(function(){
  var translations = {
    en: {
      ...
      p2_highlight: 'Zero signup — a working inbox in one click.',
      p2_desc: 'A retro hacker-themed disposable email service — instant addresses, real-time inbox polling, and a Matrix-green CRT interface. No registration required.',
      ...
      p6_highlight: '24/7 live rock radio across 5 genres, 50 curated stations, zero backend.',
      p6_desc: 'A phone-styled internet radio player — RockStation — streaming 5 curated genres (Rock, Metal, Gothic, Synthwave, Alternative) from free live streams, with favorites, shareable deep links, and lock-screen playback controls via the Media Session API, entirely client-side.',
    ...
    bg: {
      ...
      p2_highlight: 'Без регистрация — работещ пощенски адрес за секунди.',
      p2_desc: 'Ретро хакерска тематична услуга за временни имейл адреси — мигновени адреси, обновяване на входящата поща в реално време и CRT интерфейс в стил Матрицата. Без регистрация.',
      ...
      p6_highlight: '24/7 живо рок радио в 5 жанра, 50 подбрани станции, без backend.',
      p6_desc: 'Уеб плейър за интернет радио, стилизиран като телефон — RockStation — излъчващ 5 подбрани жанра (рок, метъл, готик, синтуейв, алтернативен) от безплатни живи стриймове, с любими станции, споделяеми линкове и управление от заключения екран чрез Media Session API, изцяло в браузъра.',
    ...
    ru: {
      ...
      p2_highlight: 'Без регистрации — рабочий почтовый ящик в один клик.',
      p2_desc: 'Сервис одноразовой почты в ретро-хакерском стиле — мгновенные адреса, обновление входящих в реальном времени и CRT-интерфейс в стиле Матрицы. Без регистрации.',
      ...
      p6_highlight: 'Круглосуточное живое рок-радио в 5 жанрах, 50 подобранных станций, без бэкенда.',
      p6_desc: 'Веб-плеер интернет-радио в виде телефона — RockStation — транслирующий 5 подобранных жанров (рок, метал, готик, синтвейв, альтернатива) из бесплатных живых потоков, с избранным, ссылками для быстрого доступа и управлением с экрана блокировки через Media Session API, полностью на стороне клиента.',
    ...
    de: {
      ...
      p2_highlight: 'Keine Anmeldung — ein funktionierendes Postfach mit einem Klick.',
      p2_desc: 'Ein Wegwerf-E-Mail-Dienst im Retro-Hacker-Stil — sofortige Adressen, Echtzeit-Postfachabfrage und ein Matrix-grünes CRT-Interface. Keine Registrierung erforderlich.',
      ...
      p6_highlight: '24/7 Live-Rockradio in 5 Genres, 50 kuratierte Sender, kein Backend.',
      p6_desc: 'Ein wie ein Smartphone gestalteter Internetradio-Player — RockStation — der 5 kuratierte Genres (Rock, Metal, Gothic, Synthwave, Alternative) aus kostenlosen Live-Streams abspielt, mit Favoriten, teilbaren Links und Sperrbildschirm-Steuerung über die Media Session API, vollständig clientseitig.',
