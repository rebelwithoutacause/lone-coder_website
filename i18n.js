(function(){
  var translations = {
    en: {
      ...
      about_bio: 'Lone Coder is an independent software developer and QA professional, working on project-based solutions for businesses and individuals. I build and test web applications, backend systems, and Chrome extensions, with a focus on quality, reliability, and user experience. I work directly with clients to understand their requirements and deliver custom software projects from concept to completion — requirements gathering, planning, execution, and ongoing maintenance, all handled end-to-end. Services include software development, manual & automation testing, API testing, bug detection, test automation, and Docker-based deployment.',
      ...
      p1_desc: 'A retro terminal-style password generator with random, pattern, pronounceable, and passphrase modes, plus strength analysis and batch generation.',
      ...
      p4_desc: 'A horror-inspired reinterpretation of the classic ELIZA chatbot, in the spirit of Harvester (1996) — a ~25-topic conversation engine with short-term memory, running entirely in the browser.',
      ...
      footer_text: '© 2026 Lone Coder. Built, tested, and shipped independently.',
    ...
    bg: {
      ...
      about_bio: '„Lone Coder“ е независим софтуерен разработчик и QA специалист, работещ по проектна основа за бизнеси и частни клиенти. Изграждам и тествам уеб приложения, backend системи и Chrome разширения, с фокус върху качество, надеждност и потребителско изживяване. Работя директно с клиентите, за да разбера изискванията им и да доставя индивидуални софтуерни проекти от идея до завършен продукт — събиране на изисквания, планиране, изпълнение и поддръжка, всичко на едно място. Услугите включват софтуерна разработка, ръчно и автоматизирано тестване, API тестване, откриване на бъгове, тест автоматизация и Docker-базирано разгръщане.',
      ...
      p1_desc: 'Ретро терминален генератор на пароли с режими: произволен, по образец, произносим и passphrase, плюс анализ на сигурността и генериране на партиди.',
      ...
      p4_desc: 'Хорър интерпретация на класическия чатбот ELIZA, в духа на Harvester (1996) — диалогов модул с ~25 теми и краткосрочна памет, работещ изцяло в браузъра.',
      ...
      footer_text: '© 2026 Lone Coder. Разработен, тестван и доставян самостоятелно.',
    ...
    ru: {
      ...
      about_bio: 'Lone Coder — независимый разработчик программного обеспечения и специалист по контролю качества, работающий над проектами для компаний и частных клиентов. Я создаю и тестирую веб-приложения, backend-системы и расширения для Chrome, уделяя особое внимание качеству, надёжности и удобству использования. Я работаю напрямую с клиентами, чтобы понять их требования и реализовать индивидуальные программные проекты от идеи до готового продукта — сбор требований, планирование, разработка и последующая поддержка, всё в одном месте. Услуги включают разработку ПО, ручное и автоматизированное тестирование, тестирование API, поиск ошибок, автоматизацию тестирования и развёртывание на основе Docker.',
      ...
      p1_desc: 'Генератор паролей в ретро-терминальном стиле с режимами: случайный, по шаблону, произносимый и passphrase, плюс анализ надёжности и пакетная генерация.',
      ...
      p4_desc: 'Хоррор-переосмысление классического чат-бота ELIZA в духе Harvester (1996) — диалоговый движок с ~25 темами и кратковременной памятью, полностью работающий в браузере.',
      ...
      footer_text: '© 2026 Lone Coder. Разработано, протестировано и запущено самостоятельно.',
    ...
    de: {
      ...
      p1_desc: 'Ein Passwortgenerator im Retro-Terminal-Stil mit Zufalls-, Muster-, aussprechbarem und Passphrase-Modus, inklusive Sicherheitsanalyse und Stapelgenerierung.',
      ...
      p4_desc: 'Eine Horror-Neuinterpretation des klassischen ELIZA-Chatbots im Geiste von Harvester (1996) — eine Dialog-Engine mit ~25 Themen und Kurzzeitgedächtnis, die vollständig im Browser läuft.',
      ...
      footer_text: '© 2026 Lone Coder. Eigenständig entwickelt, getestet und bereitgestellt.',
